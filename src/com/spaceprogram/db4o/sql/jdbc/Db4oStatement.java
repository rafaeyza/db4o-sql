 ...
 * Time: 4:49:10 PM
 */
public class Db4oStatement implements Statement {
    private Db4oConnection conn;

    public Db4oStatement(Db4oConnection db4oConnection) {
        this.conn = db4oConnection;
    }
    ...
    public ResultSet executeQuery(String query) throws SQLException {
        ...
        return new Db4oResultSet(results);
    }
